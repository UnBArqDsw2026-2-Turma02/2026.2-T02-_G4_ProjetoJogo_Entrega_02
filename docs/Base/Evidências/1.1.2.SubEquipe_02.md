...
| Aprovação do diagrama de casos de uso através da comparação com o diagrama de casos de uso e a lista de requisitos, identificado que faltou algumas regras na versão antiga | Modelagem Estática | [Visualizar gravação](https://youtu.be/oHxGYeOGddU) |
