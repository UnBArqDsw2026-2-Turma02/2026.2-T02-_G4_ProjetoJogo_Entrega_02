...
| Reunião | Descrição | Link |
|---|---|---|
| 17/09/2026 |  Reunião de aprovação do Diagrama de Casos de Uso, de Classes e de Estados  (UML estática integrando gamificação e método Pomodoro), validação dos refinamentos via IA e alinhamento com a literatura técnica. | [Visualizar ata](../assets/subEquipe02/ata_aprovacao_diagramas.pdf) | |
