...
| `diagrama-estados-habito.puml` | Prototipação e estruturação iterativa da máquina de estados do ciclo de vida do Hábito. | <a href="/Base/assets/subEquipe03/diagrama-habito.puml" download>Baixar arquivo .puml</a> / ![Diagrama de Estados - Hábito gerado](../assets/subEquipe03/diagrama-estados-habito-puml.png) |