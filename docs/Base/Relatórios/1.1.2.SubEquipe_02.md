...
| Pablo Cunha | Lições Aprendidas | Uso da IA Generativa (SENSO CRÍTICO) |
...
|---|---|---|---|
|[Pablo Cunha de Jesus](https://github.com/Pabloo8)|  [Elaboração do Diagrama de Classes e do Diagrama de Casos de Uso](../Relatórios/1.1.2.SubEquipe_02.md)|  | 15/09/2026 |
