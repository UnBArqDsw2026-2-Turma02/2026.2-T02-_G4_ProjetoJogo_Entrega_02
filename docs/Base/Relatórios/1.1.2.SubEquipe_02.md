...
| [Ana Luiza Borba de Abrantes](https://github.com/luabrantess) | [Aprovação do Diagrama de Classes e do Diagrama de Casos de Uso por meio do uso de IA para comparar ambos, identificado que faltou a visão do desenvolvedor](../Relatórios/1.1.2.SubEquipe_02.md) | [Diagrama de Classes](../assets/subEquipe02/diagramaDeClasses.png) e [Diagrama de Casos de Uso](../assets/subEquipe02/diagramaCasosDeUso.png) | 16/09/2026 |
